  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10">
        ...
        {/* AI Education Session - Top Right */}
        <div
        ...
        {/* AI Strategy & Roadmap - Bottom Left */}
        <div
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => printContent('agenda-education-modal-content', 'AI Education Session')}
          ...
          <div id="agenda-education-modal-content" className="mt-6">
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => printContent('agenda-governance-modal-content', 'AI Governance Foundation')}
                className="flex items-center gap-2 text-sm text-accent hover:text-accent/80 transition-colors print:hidden"
              >
                <Printer className="h-4 w-4" />
                Print to PDF
          ...
          <div id="agenda-governance-modal-content" className="mt-6">
            <p className="text-muted-foreground mb-8">
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => printContent('agenda-enablement-modal-content', 'AI Enablement')}
                className="flex items-center gap-2 text-sm text-accent hover:text-accent/80 transition-colors print:hidden"
              >
                <Printer className="h-4 w-4" />
                Print to PDF
          ...
          <div id="agenda-enablement-modal-content" className="mt-6">
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => printContent('agenda-strategy-modal-content', 'AI Strategy & Roadmap')}
                className="flex items-center gap-2 text-sm text-accent hover:text-accent/80 transition-colors print:hidden"
              >
                <Printer className="h-4 w-4" />
                Print to PDF
          ...
          <div id="agenda-strategy-modal-content" className="mt-6">
            <p className="text-muted-foreground mb-8">
...
export default AgendaSMAdvisorsTab;
