        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <div className="flex items-start justify-between">
              ...
              <button
                onClick={() => printContent('briefing-enablement-modal-content', 'AI Enablement')}
          ...
          <div id="briefing-enablement-modal-content" className="mt-6">
